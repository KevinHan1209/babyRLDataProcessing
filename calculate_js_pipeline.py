...
def load_agent_distributions(pkl_path="states/averaged_state_distributions.pkl"):
...
def calculate_js_divergence_pipeline(csv_path, pkl_path="states/averaged_state_distributions.pkl", verbose=False):
    """
    ...
    Args:
        ...
        pkl_path (str): Path to the agent distribution pickle file (default: states/averaged_state_distributions.pkl)
...
def main():
    ...
    parser.add_argument('--pkl-path', default='states/averaged_state_distributions.pkl', 
